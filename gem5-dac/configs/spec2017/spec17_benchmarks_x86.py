...
# data = 'makerand.pl'
# perlbench_r.cmd = [perlbench_r.executable] + ['-I./lib',data]
...
x264_r.executable = 'x264_r' + x86_suffix
...
x264_s.executable = 'x264_s' + x86_suffix
...
specrand_is.executable = 'specrand_is' + x86_suffix
specrand_is.cmd = [specrand_is.executable] + ['324342', '24239']

#999.specrand_ir    
specrand_ir = Process(pid = 999) 
specrand_ir.executable = 'specrand_ir' + x86_suffix
...
pop2_s.executable = 'speed_pop2' + x86_suffix
...
specrand_fs.executable = 'specrand_fs' + x86_suffix
# specrand_fs.cmd = [specrand_fs.executable] + ['324342 24239']
specrand_fs.cmd = [specrand_fs.executable] + ['324342', '24239']

#997.specrand_fr       
specrand_fr = Process(pid = 997) 
specrand_fr.executable = 'specrand_fr' + x86_suffix
